...
{
    public static class Filter_Cake_Recl_AnalysisSvc
    {
        static Filter_Cake_Recl_AnalysisSvc()
        {
            Util.RegisterOracle();
        }


        public static Filter_Cake_Recl_Analysis Get(DateTime sdate, byte stepNbr, byte interval)
        {
            ...
            Filter_Cake_Recl_Analysis retVal = null;
        ...
        public static List<Filter_Cake_Recl_Analysis> GetByDateRange(DateTime startDate, DateTime endDate)
        {
            StringBuilder sql = new();
            sql.Append(GetSelect());
            sql.AppendLine("WHERE sdate BETWEEN :startDate AND :endDate");

            List<Filter_Cake_Recl_Analysis> elements = [];
            using OracleConnection conn = new(MOO.Data.GetConnectionString(MOO.Data.MNODatabase.DMART));
            conn.Open();
            OracleCommand cmd = new(sql.ToString(), conn);
            cmd.BindByName = true;
        ...
        private static string GetSelect()
        {
            ...
            sql.AppendLine("FROM tolive.filter_cake_recl_analysis");
            return sql.ToString();
        }


        public static int Insert(Filter_Cake_Recl_Analysis obj)
        {
            using OracleConnection conn = new(MOO.Data.GetConnectionString(MOO.Data.MNODatabase.DMART));
            conn.Open();
        ...
        public static int Insert(Filter_Cake_Recl_Analysis obj, OracleConnection conn)
        {
           
            StringBuilder sql = new();
            sql.AppendLine("INSERT INTO tolive.Filter_Cake_Recl_Analysis(");
        ...
        public static int Update(Filter_Cake_Recl_Analysis obj)
        {
        ...
        public static int Update(Filter_Cake_Recl_Analysis obj, OracleConnection conn)
        {
            StringBuilder sql = new();
            sql.AppendLine("UPDATE tolive.Filter_Cake_Recl_Analysis SET");
        ...
        /// </summary>
        public static int UpdateComponent(DateTime shiftDate, byte stepNbr, byte interval, 
                                Filter_Cake_Recl_Analysis.FilterCakeReclaimComponent componentName, decimal? componentValue)
        {
            using OracleConnection conn = new(MOO.Data.GetConnectionString(Data.MNODatabase.DMART));
            conn.Open();
        ...
        /// </summary>
        public static int UpdateComponent(DateTime shiftDate, byte stepNbr, byte interval, 
                                Filter_Cake_Recl_Analysis.FilterCakeReclaimComponent componentName, decimal? componentValue, OracleConnection conn)
        {
            StringBuilder sql = new();
            sql.AppendLine("UPDATE tolive.filter_cake_recl_analysis SET");
        ...
        public static int Delete(Filter_Cake_Recl_Analysis obj)
        {
            using OracleConnection conn = new(MOO.Data.GetConnectionString(Data.MNODatabase.DMART));
            conn.Open();
        ...
        public static int Delete(Filter_Cake_Recl_Analysis obj, OracleConnection conn)
        {
            StringBuilder sql = new();
            sql.AppendLine("DELETE FROM tolive.Filter_Cake_Recl_Analysis");
            sql.AppendLine("WHERE sdate = :sdate");
            sql.AppendLine("AND step = :step ");
            sql.AppendLine("AND intv = :intv ");
        ...
        internal static Filter_Cake_Recl_Analysis DataRowToObject(DbDataReader row, string ColPrefix = "")
        {
            Filter_Cake_Recl_Analysis RetVal = new();
