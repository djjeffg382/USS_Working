...
{
    public class FS_RentalEquipSvc
    {
        static FS_RentalEquipSvc()
        {
            Util.RegisterOracle();
        }


        public static FS_RentalEquip Get(decimal rental_equip_id)
        {
        ...
        public static List<FS_RentalEquip> GetAll(bool onlyActive = true, MOO.Plant? plant = null)
        {
            StringBuilder sql = new();
            sql.Append(GetSelect());
            if (onlyActive)
            ...
            DataSet ds = MOO.Data.ExecuteQuery(da);
            List<FS_RentalEquip> elements = new();
            if (ds.Tables[0].Rows.Count >= 1)
            {
        ...
        public static int Insert(FS_RentalEquip obj)
        {
        ...
        public static int Insert(FS_RentalEquip obj, OracleConnection conn)
        {
        ...
        public static int Update(FS_RentalEquip obj)
        {
            using OracleConnection conn = new(MOO.Data.GetConnectionString(Data.MNODatabase.DMART));
            conn.Open();
        ...
        public static int Update(FS_RentalEquip obj, OracleConnection conn)
        {
            StringBuilder sql = new();
        ...
        public static int Delete(FS_RentalEquip obj)
        {
            using OracleConnection conn = new(MOO.Data.GetConnectionString(Data.MNODatabase.DMART));
            conn.Open();
        ...
        public static int Delete(FS_RentalEquip obj, OracleConnection conn)
        {
            StringBuilder sql = new();
        ...
        private static FS_RentalEquip DataRowToObject(DataRow row)
        {
            FS_RentalEquip RetVal = new();
